...
const (
	// app_api请求service
	TenantApp = "com.shangyikangyou.huimaibao.api.tenant"
)
...
var (
	...
	whiteList = map[string]bool{
		"TenantAPI.SignInTenantAdmin":               true,
		"TenantAPI.SignInTenantAdminByPhone":        true,
		"TenantAPI.RefreshAccessToken":              true,
		"TenantAPI.ResetAdminPassword":              true,
