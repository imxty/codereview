...
// 修改组织手机号
func (s *OrganizationAPIHandler) UpdateOrganizationPhone(ctx context.Context, req *pb.UpdateOrganizationPhoneRequest, rsp *pb.UpdateOrganizationPhoneResponse) error {
	...
	// 发送请求
	_, err = s.userAPI.UpdateOrganizationPhone(ctx, &userv1.UpdateOrganizationPhoneRequest{
		// 组织ID
